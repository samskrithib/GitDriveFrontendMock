...
(function () {
  ...
  /** @ngInject */
  function ViewMyRunsInputController(moment, viewMyRunsUrlGeneratorService, $scope, $filter, $timeout, $log, $location, typeaheadService, httpCallsService, UtilityService) {
    var vm = this;
